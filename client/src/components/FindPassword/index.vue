<template>
  <div class="password_body">
    <div class="password_email">
      邮箱：
      <input v-model="email" type="text" class="password_text" />
      <button @touchstart="handleToVerify">发送验证码</button>
    </div>
    <div>
      密码：
      <input v-model="password" type="password" class="password_text" />
    </div>
    <div>
      验证码：
      <input v-model="verify" type="text" class="password_text" />
    </div>
